...
public class NotesController {
    ...
    /*
     * This string list contains all the availible files that the user has opened during the
    ...
    /*
     * The SplitPane which is the building block of the app and comes after the main VBox, and sed to seperate the TextArea 
    ...
    /*
     * The VBox main contains every single element/object that you can visually see in the game.
     ...
     * constructor does NOT have access to the @FXML annotated fields. The initialize method 
     * is being used to style the app, such as adding colour to the background and enabling effects.
     */
    @FXML
    ...
    /*
     * This method displays the availible files to choose from via a alert pop up display.
     */
    @FXML
    ...
    /*
     * This is a major method which is used to make new notes when the button is clicked.
     * It is also the same method which allows the user to delete the note, or edit the file name.
     */
    @FXML
    public void newNote() throws IOException {
        ...
        button.setOnMouseClicked(event -> {
            //when clicked twice you can edit the note name to whatever you like via a dialog box
            ...
            //if clicked once, the user opens the note corresponding to the note name they clicked
            else {
                textArea.clear();
    ...
    /*
     * Calls a method which saves the file by writing it into a .txt file on desktop.
     */
    @FXML
    ...
    /*
     * Calls a method which receives data from a .txt file and puts it on the TextArea.
     */
    @FXML
    ...
    /**
     * This method is used to indent the line whenever the user uses a "-" sign at the start
     ...
     * note name.
     * 
     * @param currentLabel The current note name where the user recently inputted data
     */
    private void fileWriter(String currentLabel) {
        ...
        try {
            //makes a new file
            File file = new File(currentLabel + ".txt");
            //checks whether the file exists or not, if it doesnt, then makes a new one and if it
